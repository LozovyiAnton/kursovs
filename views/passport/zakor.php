...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Заявка на отримання закордонного паспорту</h4>
        ...
        <form class="forms-sample" method="post">
            ...
            <div class="form-group">
                <label for="exampleInputName1">Місце народження</label>
                <input type="text" class="form-control" id="exampleInputName1" name="city_of_birth" placeholder="city_of_birth">
            </div>
            <div class="form-group">
